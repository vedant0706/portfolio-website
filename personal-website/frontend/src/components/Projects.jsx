...
import job_portal from "../assets/job-portal.png";
import clerk_auth from "../assets/clerk_auth.jpeg"
    ...
    <div className="pb-8 pt-20 sm:pb-12 md:pb-16 lg:pb-24 sm:px-6 md:px-10 lg:px-10">
      ...
      <div className="pt-8 sm:pt-12 md:pt-16 lg:pt-24 pb-8 sm:pb-12 md:pb-16 lg:pb-24 flex flex-col lg:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 px-2">
        <div className="p-1.5 sm:p-2 md:p-3 rounded-lg sm:rounded-2xl md:rounded-3xl lg:rounded-4xl bg-zinc-950 w-full max-w-sm md:max-w-md lg:max-w-none lg:w-auto">
          <div className="bg-gradient-to-r from-purple-900 to-purple-950 shadow-lg sm:shadow-xl shadow-purple-800 rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden cursor-pointer hover:shadow-white/70 transition-shadow duration-300">
            <Link
              to="https://job-portal-client-eight-sigma.vercel.app"
              target="_blank"
            >
              <div className="flex flex-col sm:flex-row items-center justify-between p-3 sm:p-4 md:p-6 lg:p-8">
                <p className="text-md sm:text-sm md:text-lg lg:text-xl text-white font-semibold text-center sm:text-left max-w-xs md:max-w-sm lg:max-w-lg">
                  A modern recruitment platform for secure authentication, job
                  search, application tracking, and recruiter-managed job
                  postings with a clean, scalable, and user-friendly design.
                </p>
        ...
        <div className="w-full lg:w-auto max-w-2xl lg:max-w-xl px-2">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-black dark:text-gray-300 roboto-para leading-relaxed">
            JOB PORTAL is a full-stack recruitment web application designed to
            connect job seekers and recruiters through a secure and
            user-friendly platform with production-ready architecture and
            scalable backend services. The platform focuses on simplifying the
            hiring process while providing efficient job management and
            application tracking features for recruiters.
          </p>
          <br />
          <ul className="space-y-1.5 sm:space-y-2 md:space-y-3 mb-4 sm:mb-6 md:mb-8 roboto-para text-xs sm:text-sm md:text-base lg:text-lg">
            <li className="flex gap-2 items-start">
              <span className="dark:text-purple-700 text-purple-700 text-sm sm:text-base md:text-lg mt-0.5 flex-shrink-0">
                ✦
              </span>
              <span>
                Authentication using Google/email login with Clerk, JWT
            ...
            <li className="flex gap-2 items-start">
              ...
              <span>
                Role-based access control for Applicants and Recruiters with
                protected routes.
              </span>
            </li>
            <li className="flex gap-2 items-start">
              ...
              <span>
                Built complete workflows for job posting, job listing,
                application submission, and application status tracking (Accept
                / Reject / Pending).
              </span>
            </li>
            <li className="flex gap-2 items-start">
              ...
              <span>
                Developed a recruiter dashboard for job management, application
            ...
            <li className="flex gap-2 items-start">
              ...
              <span>
                Created a responsive MERN application with REST APIs, MongoDB
                integration, error handling, and production deployment.
              </span>
            </li>
          </ul>
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 mt-3 md:mt-6">
            ...
            <p className="flex text-white items-center justify-center gap-1 text-xs sm:text-md md:text-lg font-semibold border border-gray-600 bg-gray-950 px-2 sm:px-2.5 md:px-3 py-1 sm:py-1.5 md:py-2 rounded-lg">
              <span className="text-blue-600 text-xs md:text-lg">
                {/* <SiRazorpay /> */}
                <img src={clerk_auth} className="h-5 w-5" alt="" />
              </span>
              Clerk Auth
            </p>
          </div>
